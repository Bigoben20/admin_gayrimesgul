<div wire:ignore.self>
    <div class="p-4 mb-4 flex flex-col lg:flex-row justify-between items-stretch lg:items-end bg-gray-200 dark:bg-gray-800 border border-gray-400 rounded-lg gap-4 lg:gap-0">
        <div class="flex flex-col md:flex-row justify-between items-stretch lg:items-end gap-4">
            <x-labeled-file label="mp3 Yükle" class="bg-gray-50 dark:bg-gray-800" wire:model.defer="mp3.file" accept="audio/*"></x-labeled-file>
            <x-labeled-input label="Ad" class="bg-gray-50 dark:bg-gray-800" wire:model.defer="mp3.title"></x-labeled-input>
        ...
        <button type="button"
            ...
            wire:click="store" data-te-ripple-init data-te-ripple-color="light">
            Ses Ekle
        </button>
    </div>
    <div>
