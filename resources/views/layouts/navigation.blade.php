<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block w-auto h-12 pt-2 text-gray-800 fill-current dark:text-gray-200" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('audios.show')" :active="request()->routeIs('audios.show')">
                        {{ __('Audios') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <!-- Hamburger -->
            <div class="flex items-center gap-4 -mr-2 sm:hidden">
                <div class="px-4">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('audios.show')" :active="request()->routeIs('audios.show')">
                {{ __('Audios') }}
            </x-responsive-nav-link>
        </div>
