...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 bgImage" style="background-image: url({{ asset('img/GayriLogoTransparan.png') }});">
            ...
            <!-- Page Content -->
            <main class="min-h-screen backdrop-blur-md">
                {{ $slot }}
            </main>
        </div>
